        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:pb-32 md:pt-64 lg:px-20">
          ...
          >
            ...
            <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
              Unlock the full potential of artificial intelligence with Appify
              Intelligence&apos;s strategic consultancy services. As a boutique AI
              partner, we help ambitious organisations translate emerging AI capabilities
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-gray-900">
                <p>
                  <strong>Deep technical & business expertise:</strong> Our consultants
                  combine leading-edge AI knowledge with practical industry insight to
                  identify and deliver high-impact opportunities.
                </p>
                <p>
                  <strong>Tailored strategies:</strong> We build bespoke AI roadmaps
                  aligned to your sector, objectives, and growth priorities.
                </p>
                <p>
                  <strong>End-to-end partnership:</strong> From opportunity assessment to
                  implementation planning and change enablement, we guide you through
                  every stage of your AI journey.
                </p>
                <p>
                  <strong>Proven results:</strong> Our work drives efficiency gains, cost
                  savings, and revenue growth across diverse industries.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-gray-900">
                <p>
                  We operate as an extension of your team — analysing your business
                  landscape, prioritising the most valuable AI opportunities, and
                  designing clear execution plans.
                </p>
                <p>
                  Whether you&apos;re just starting with AI or scaling existing
                  initiatives, our frameworks and experience ensure your investment
        ...
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="animate-fade-in-up animation-delay-100 group rounded-[8px] bg-gray-50 p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              <div className="mb-4 h-1 w-12 bg-[#FFB300]"></div>
              <h3 className="text-xl font-semibold text-gray-900">
                Readiness assessments and opportunity analysis
              </h3>
            </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-900">
                We simplify complex AI technologies and translate them into actionable
                business value. Our consultancy equips you to move faster, innovate
                confidently, and stay ahead in a rapidly evolving digital economy.
              </p>
            </div>
