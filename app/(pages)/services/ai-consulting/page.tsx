          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:pb-32 md:pt-64 lg:px-20">
            ...
            >
              ...
              <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
                ...
                partner, we help ambitious organisations translate emerging AI
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                ...
                <div className="space-y-6 text-lg text-gray-900">
                  ...
                  <p>
                    <strong>End-to-end partnership:</strong> From opportunity assessment
                    to implementation planning and change enablement, we guide you through
                    every stage of your AI journey.
                  </p>
                  <p>
                    <strong>Proven results:</strong> Our work drives efficiency gains,
                    cost savings, and revenue growth across diverse industries.
                  </p>
                </div>
              </div>
