  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Redefine engagement with AI chatbots and intelligent agents designed for real-world business impact. Our solutions deliver human-like conversations that scale support."
        />
        <link
          rel="canonical"
          href="https://appifyintelligence.com/services/ai-chatbots-agents"
        />
      </Head>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:pb-32 md:pt-64 lg:px-20">
            ...
            >
              ...
              <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
                Redefine engagement with AI chatbots and intelligent agents designed for
                real-world business impact. Our solutions deliver human-like conversations
                that scale support, improve satisfaction, and boost efficiency.
              </p>
            </div>
          </div>
          <div
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                ...
                <div className="space-y-6 text-lg text-gray-900">
                  <p>
                    <strong>Conversational intelligence:</strong> We use state-of-the-art
                    NLP to build agents that understand context, learn continuously, and
                    respond naturally.
                  </p>
                  <p>
                    <strong>Tailored to your use case:</strong> Whether for candidate
                    screening, training, or well-being support, we design solutions
                    aligned to your goals and audience.
                  </p>
                  <p>
                    <strong>Seamless integration:</strong> Deploy across web, mobile, and
                    internal platforms for consistent, 24/7 support.
                  </p>
                  <p>
                    <strong>Measurable results:</strong> Reduce manual workloads, speed up
                    responses, and deliver always-on engagement at scale.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div
                ...
                className={`flex h-full justify-center transition-all duration-1000 lg:justify-start ${
                  visibleElements.has("what-we-build-image")
                    ? "translate-x-0 opacity-100"
                    : "-translate-x-20 opacity-0"
                }`}
              >
              ...
              {/* Text Content */}
              <div
                id="what-we-build-text"
                data-animate="true"
                className={`transition-all duration-1000 ${
                  visibleElements.has("what-we-build-text")
                    ? "translate-x-0 opacity-100"
                    : "translate-x-20 opacity-0"
                }`}
              >
                ...
                <div className="space-y-4 text-lg text-gray-900">
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      ...
                      Candidate screening and onboarding bots
                    </li>
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                      Training and personal development assistants
                    </li>
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                      Mental health and CBT support agents
                    </li>
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="animate-fade-in-up animation-delay-300 group rounded-[8px] bg-gray-50 p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                <div className="mb-4 h-1 w-12 bg-[#FFB300]"></div>
                <h3 className="text-xl font-semibold text-gray-900">FAQ automation</h3>
              </div>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-900">
                  Our intelligent agents become digital team members — enhancing user
                  experiences, supporting staff, and extending your service capabilities.
                  Every solution is secure, scalable, and aligned with your brand.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-lg text-gray-900">
                  Our AI chatbots and intelligent agents are transforming engagement
                  across recruitment, learning, and wellbeing. From automated candidate
                  screening that accelerates hiring to training assistants that enhance
                  learner interaction and wellbeing agents providing continuous support,
                  we deliver measurable efficiency gains and stronger user experiences.
                </p>
              </div>
              <div
                id="success-card-1"
              ...
              <div className="relative z-10">
                ...
                <div className="relative mb-12 text-center">
                  <p className="text-xl text-gray-700 md:text-2xl">
                    Apply here for a free 30-minute consultation to explore how AI agents
