            ...
            >
              ...
              <div className="space-y-6 text-lg text-gray-900">
                ...
                <p>
                  ...
                  screening, training, or well-being support, we design solutions aligned
        ...
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="text-lg text-gray-900">
                Our AI chatbots and intelligent agents are transforming engagement across
                recruitment, learning, and wellbeing. From automated candidate screening
                that accelerates hiring to training assistants that enhance learner
                interaction and wellbeing agents providing continuous support, we deliver
                measurable efficiency gains and stronger user experiences.
              </p>
            </div>
            <div
              id="success-card-1"
