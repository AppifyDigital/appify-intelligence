        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:pb-32 md:pt-64 lg:px-20">
          ...
          >
            ...
            <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
              Enhance productivity, lower costs, and unlock new capabilities with
              AI-powered automation. Appify Intelligence designs intelligent systems that
              streamline workflows and eliminate operational bottlenecks.
            </p>
          </div>
        </div>
        <div
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-gray-900">
                <p>
                  <strong>Expert automation design:</strong> We combine AI engineering
                  with process optimisation to create scalable, robust solutions.
                </p>
                <p>
                  <strong>End-to-end delivery:</strong> From process mapping to full
                  implementation, we handle the complete automation lifecycle.
                </p>
                <p>
                  <strong>Seamless system integration:</strong> Our solutions connect to
                  existing HR, CRM, and operations platforms with minimal disruption.
                </p>
                <p>
                  <strong>Human-centric focus:</strong> We automate repetitive tasks,
                  allowing your team to focus on strategic, high-value work.
                </p>
              </div>
            </div>
      ...
      <section className="w-full bg-gray-100 py-20">
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            {/* Text Content */}
            <div
              id="automation-capabilities-text"
              data-animate="true"
              className={`transition-all duration-1000 ${
                visibleElements.has("automation-capabilities-text")
                  ? "translate-x-0 opacity-100"
                  : "translate-x-20 opacity-0"
              }`}
            >
              ...
              <div className="space-y-4 text-lg text-gray-900">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                    AI-assisted decision support and approvals
                  </li>
                  <li className="flex items-center">
                    <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                    Platform integration (HR, CRM, operations)
                  </li>
                  <li className="flex items-center">
                    <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-900">
                Intelligent automation is a growth driver. Our clients achieve faster
                turnaround times, lower costs, improved compliance, and enhanced service —
                all while maintaining a human touch in critical interactions.
              </p>
            </div>
      ...
      <section className="w-full bg-white py-20">
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {/* Header */}
            <div
              id="proven-results-header"
              data-animate="true"
              className={`mb-16 max-w-xl transition-all duration-1000 md:p-4 ${
                visibleElements.has("proven-results-header")
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
              }`}
            >
              ...
              <p className="text-lg text-gray-900">
                We&apos;ve delivered automation that accelerates recruitment, manages
                contracts, streamlines training, and improves response times — driving
                measurable productivity and client satisfaction.
              </p>
            </div>
            <div
              id="success-card-1"
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="mb-8 text-center text-4xl font-bold text-gray-900 md:text-5xl">
                Let&apos;s automate for advantage
              </h2>

              <div className="relative mb-12 text-center">
                <p className="text-xl text-gray-700 md:text-2xl">
                  Apply here for a free 30-minute consultation to explore how automation
