  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Supercharge your organisation's intelligence with Retrieval-Augmented Generation (RAG). Appify Intelligence builds advanced systems that combine generative AI with real-time data access."
        />
        <link
          rel="canonical"
          href="https://appifyintelligence.com/services/rag-systems"
        />
      </Head>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:pb-32 md:pt-64 lg:px-20">
            ...
            >
              ...
              <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
                Supercharge your organisation&apos;s intelligence with Retrieval-Augmented
                Generation (RAG). Appify Intelligence builds advanced systems that combine
                generative AI with real-time data access to deliver accurate,
        ...
        <section className="w-full bg-white py-20">
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
            ...
            >
              ...
              <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
                RAG systems fuse generative AI with retrieval layers, enabling you to
                generate insights grounded in live, relevant data. This approach ensures
                answers are creative, factual, and actionable.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                ...
                <div className="space-y-6 text-lg text-gray-900">
                  <p>
                    <strong>Technical excellence:</strong> We design enterprise-grade RAG
                    systems optimised for performance, scalability, and compliance.
                  </p>
                  <p>
                    <strong>Sector-specific solutions:</strong> Our platforms are
                    customised for industries where precision and context matter most.
                  </p>
                  <p>
                    <strong>Full project delivery:</strong> From data integration to
                    deployment and ongoing optimisation, we manage the entire lifecycle.
                  </p>
                  <p>
                    <strong>Security & compliance:</strong> We build with data governance
                    and regulatory requirements front of mind.
                  </p>
                </div>
              </div>
        ...
        <section className="w-full bg-gray-100 py-20">
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              {/* Text Content */}
              <div
                id="rag-capabilities-text"
                data-animate="true"
                className={`transition-all duration-1000 ${
                  visibleElements.has("rag-capabilities-text")
                    ? "translate-x-0 opacity-100"
                    : "translate-x-20 opacity-0"
                }`}
              >
                ...
                <div className="space-y-4 text-lg text-gray-900">
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                      Content generation with live data integration
                    </li>
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                      Industry-specific RAG for recruitment, legal, learning, marketing,
                      and logistics
                    </li>
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                    ...
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                      Seamless business system integrations
                    </li>
                    <li className="flex items-center">
                      <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-900">
                  RAG transforms decision-making. Your teams gain faster access to
                  accurate insights, enhance client service, and uncover new opportunities
                  — keeping you ahead in a fast-changing landscape.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-20">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-lg text-gray-900">
                  Our AI RAG systems are driving better decision-making and operational
                  intelligence across sectors, including legal, recruitment, learning, and
                  logistics. By combining generative AI with live data retrieval, clients
                  achieve faster, more accurate insights, reduce research time, and
                  maintain full confidence in the reliability of their information.
                </p>
              </div>
              <div
                id="success-card-1"
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="mb-8 text-center text-4xl font-bold text-gray-900 md:text-5xl">
                  Let&apos;s create your RAG now
                </h2>

                <div className="relative mb-12 text-center">
                  <p className="text-xl text-gray-700 md:text-2xl">
                    Apply here for a free 30-minute consultation to see how RAG can
