        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 md:pb-32 md:pt-64 lg:px-20">
          ...
          >
            ...
            <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-700 md:text-2xl">
              ...
              generative AI with real-time data access to deliver accurate, context-aware
              insights.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-gray-900">
                ...
                <p>
                  <strong>Sector-specific solutions:</strong> Our platforms are customised
                  for industries where precision and context matter most.
                </p>
                <p>
            ...
            >
              ...
              <div className="space-y-4 text-lg text-gray-900">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
                    Industry-specific RAG for recruitment, legal, learning, marketing, and
                    logistics
                  </li>
                  <li className="flex items-center">
                    <span className="mr-3 mt-1 h-2 w-2 rounded-full bg-[#FFB300]"></span>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-900">
                RAG transforms decision-making. Your teams gain faster access to accurate
                insights, enhance client service, and uncover new opportunities — keeping
                you ahead in a fast-changing landscape.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="text-lg text-gray-900">
                ...
                achieve faster, more accurate insights, reduce research time, and maintain
                full confidence in the reliability of their information.
              </p>
            </div>
            <div
              id="success-card-1"
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <p className="text-sm text-gray-200">
                  Specialized knowledge in AI integration and custom solution development
                </p>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="relative mb-12 text-center">
                <p className="text-xl text-gray-700 md:text-2xl">
                  Apply here for a free 30-minute consultation to see how RAG can elevate
