...
const caseStudies = [
  {
    ...
    team: '6 specialists',
    challenge:
      'Creating a secure, AI-driven platform to provide 24/7 mental health support with personalized interventions and crisis detection.',
    solution:
      'Developed an intelligent chatbot using GPT-4 with custom fine-tuning on mental health data, integrated with real-time sentiment analysis and automated crisis escalation protocols.',
    results: {
  ...
  },
  {
    ...
    team: '4 specialists',
    challenge:
      'Streamlining the recruitment process with AI-powered candidate screening, matching, and automated interview scheduling.',
    solution:
      'Built a comprehensive AI system featuring resume parsing with NLP, candidate-job matching algorithms, and automated video interview analysis with facial recognition and speech pattern evaluation.',
    results: {
  ...
  },
  {
    ...
    team: '8 specialists',
    challenge:
      'Creating an adaptive learning platform that personalizes educational content and tracks learning progress using AI-driven insights.',
    solution:
      'Developed an intelligent LMS with adaptive algorithms, real-time progress tracking, personalized content recommendations, and automated assessment generation.',
    results: {
  ...
  },
  {
    ...
    team: '10 specialists',
    challenge:
      'Building a predictive analytics platform to optimize sales performance and revenue forecasting using machine learning.',
    solution:
      'Created an advanced ML platform with predictive modeling, automated lead scoring, revenue forecasting, and real-time dashboard analytics.',
    results: {
...
export default function CaseStudies() {
  ...
  const openModal = (caseStudy: (typeof caseStudies)[0]) => {
          ...
          <div className="container">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                Real-world implementations that transformed businesses through intelligent
                automation
              </p>
              ...
              {caseStudies.map((study) => (
                <div key={study.id} className="case-card" onClick={() => openModal(study)}>
                  <div className="card-image-container">
                    <Image src={study.image} alt={study.title} className="card-image" width={500} height={500} />
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-header">
                <div className="modal-image-container">
                  <Image src={selectedCase.image} alt={selectedCase.title} className="modal-image" width={500} height={500} />
                  <div
                    className={`modal-gradient bg-gradient-to-br ${selectedCase.color}`}
                  ></div>
                </div>
